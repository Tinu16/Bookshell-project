                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="register_code.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                            id="confirm_password" name="confirm_password" placeholder="Repeat Password" onInput="validateConfirmPassword()">
                                            <span id="confirm_password_error" class="confirm_password_error"></span>
                                    
                                    <div class="col-sm-6">
                                        <input type="hidden" class="form-control form-control-user"
                                            id="role_customer" value="2" >
                                    </div>
                                </div>
                                <div class="col-sm-13">
                                ...
                                <hr>
                                <a href="index.html" class="btn btn-google btn-user btn-block" onClick="validateForm()">
